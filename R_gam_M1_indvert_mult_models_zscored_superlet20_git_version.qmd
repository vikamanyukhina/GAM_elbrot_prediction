---
title: "R_gam_M1_diff_dfs_and_models_superlet20_prevmodels_logpower_zscored"
format: html
editor: visual
---
...
```{r}
model_ab = bam(Rotation ~ s(Trial, Subject, bs='re') +te(AlphaPower10,Time) +te(AlphaPower12,Time) + te(BetaVolume,Time) +te(BetaPower15,Time),
                data=filter(df, Rotation<0.5), method='REML')
```
